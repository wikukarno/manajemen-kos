...
@section('content')
        ...
        <!-- WhatsApp -->
        <a class="btn btn-lg btn-primary btn-lg-square btn-whatsapp-plugin rounded-circle border-success" style=" background-color:rgb(12, 203, 12)"  href="https://api.whatsapp.com/send?phone=6281365505655&text=Assalamualikum+ada+kamar+kosong%3F" id="social"><i class="fab fa-whatsapp"></i></a>
