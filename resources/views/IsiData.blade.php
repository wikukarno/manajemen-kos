    ...
    <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <form class="form-sample" action="{{url('isi-data')}}" method="POST">
                  @csrf
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="hp" aria-describedby="hp" value="{{ auth()->user()->hp}}" disabled>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="wali" aria-describedby="wali">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="hp2" aria-describedby="hp2">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="id_telegram" aria-describedby="id_telegram">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="dokumen" aria-describedby="dokumen">
                        </div>
                      </div>
                    </div>
                  </div>
