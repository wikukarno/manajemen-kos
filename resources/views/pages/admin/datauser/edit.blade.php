                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input name="hp" id="hp" type="text" class="form-control" value="{{ $item->hp }}" autocomplete="off" placeholder="0821xxxxxx73" required/>
                          @error('hp')
                          {{-- untuk info yang salah yang mana --}}
                          <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <td><textarea name="alasan_penolakan" id="alasan_penolakan" class="form-control" autocomplete="off" placeholder="Masukkan Alasan Penolakan">{{ $item->alasan_penolakan }}</textarea><p style="font-size: 10px"><b>Catatan : </b> Max:255 karakter. Diisi jika status akun di tolak</p></td>
                        </div>
                      </div>
                    </div> 
                  </div>
